...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   render_vertical_line.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: gikarcev <gikarcev@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/02/11 17:10:29 by afruhauf          #+#    #+#             */
/*   Updated: 2026/02/13 14:39:00 by gikarcev         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	draw_wall_stripe(t_data *data, t_raycasting *ray, int x, int texX)
{
	...
	st.tex_pos = (ray->draw_start - (data->c.bob_pitch + data->c.pitch)
			- WIN_HEIGHT / 2 + ray->line_height
			* (1.0 - data->c.cam_height)) * st.step;
	st.y = ray->draw_start;
